...
set title "Performance Analysis-HandsOverHandsSet-LISTSIZE 100"
plot "../plots/throughputXupRatio_plotdata/linkedlist/JIT-off/HandsOverHandsSet/plot_LISTSIZE_100/plot.txt" using 1:2:xtic(1) title "1" with linespoints lt 7 lc 7, "../plots/throughputXupRatio_plotdata/linkedlist/JIT-off/HandsOverHandsSet/plot_LISTSIZE_100/plot.txt" using 1:3:xtic(1) title "2" with linespoints lt 5 lc 28, "../plots/throughputXupRatio_plotdata/linkedlist/JIT-off/HandsOverHandsSet/plot_LISTSIZE_100/plot.txt" using 1:4:xtic(1) title "4" with linespoints lt 9 lc 6, "../plots/throughputXupRatio_plotdata/linkedlist/JIT-off/HandsOverHandsSet/plot_LISTSIZE_100/plot.txt" using 1:5:xtic(1) title "8" with linespoints lt 2 lc 3, "../plots/throughputXupRatio_plotdata/linkedlist/JIT-off/HandsOverHandsSet/plot_LISTSIZE_100/plot.txt" using 1:6:xtic(1) title "16" with linespoints lt 9 lc 8, "../plots/throughputXupRatio_plotdata/linkedlist/JIT-off/HandsOverHandsSet/plot_LISTSIZE_100/plot.txt" using 1:7:xtic(1) title "32" with linespoints lt 4 lc 12

#500
set output '../plots/graphs/throughputXupRatio_graphs/linkedlist/JIT-off/HandsOverHandsSet/500_HandsOverHandsSet.png'
set title "Performance Analysis-HandsOverHandsSet-LISTSIZE 500"
plot "../plots/throughputXupRatio_plotdata/linkedlist/JIT-off/HandsOverHandsSet/plot_LISTSIZE_500/plot.txt" using 1:2:xtic(1) title "1" with linespoints lt 7 lc 7, "../plots/throughputXupRatio_plotdata/linkedlist/JIT-off/HandsOverHandsSet/plot_LISTSIZE_500/plot.txt" using 1:3:xtic(1) title "2" with linespoints lt 5 lc 28, "../plots/throughputXupRatio_plotdata/linkedlist/JIT-off/HandsOverHandsSet/plot_LISTSIZE_500/plot.txt" using 1:4:xtic(1) title "4" with linespoints lt 9 lc 6, "../plots/throughputXupRatio_plotdata/linkedlist/JIT-off/HandsOverHandsSet/plot_LISTSIZE_500/plot.txt" using 1:5:xtic(1) title "8" with linespoints lt 2 lc 3, "../plots/throughputXupRatio_plotdata/linkedlist/JIT-off/HandsOverHandsSet/plot_LISTSIZE_500/plot.txt" using 1:6:xtic(1) title "16" with linespoints lt 9 lc 8, "../plots/throughputXupRatio_plotdata/linkedlist/JIT-off/HandsOverHandsSet/plot_LISTSIZE_500/plot.txt" using 1:7:xtic(1) title "32" with linespoints lt 4 lc 12
...
#100
set output '../plots/graphs/C_throughputXupRatio_graphs/linkedlist/CoarseGrainedListBasedSet/100_CoarseGrainedListBasedSet.png'
set title "Performance Analysis-CoarseGrainedListBasedSet-LISTSIZE 100 - C++"
plot "../plots/C_throughputXupRatio_plotdata/linkedlist/CoarseGrainedListBasedSet/plot_LISTSIZE_100/plot.txt" using 1:2:xtic(1) title "1" with linespoints lt 7 lc 7, "../plots/C_throughputXupRatio_plotdata/linkedlist/CoarseGrainedListBasedSet/plot_LISTSIZE_100/plot.txt" using 1:3:xtic(1) title "2" with linespoints lt 5 lc 28, "../plots/C_throughputXupRatio_plotdata/linkedlist/CoarseGrainedListBasedSet/plot_LISTSIZE_100/plot.txt" using 1:4:xtic(1) title "4" with linespoints lt 9 lc 6, "../plots/C_throughputXupRatio_plotdata/linkedlist/CoarseGrainedListBasedSet/plot_LISTSIZE_100/plot.txt" using 1:5:xtic(1) title "8" with linespoints lt 2 lc 3, "../plots/C_throughputXupRatio_plotdata/linkedlist/CoarseGrainedListBasedSet/plot_LISTSIZE_100/plot.txt" using 1:6:xtic(1) title "16" with linespoints lt 9 lc 8, "../plots/C_throughputXupRatio_plotdata/linkedlist/CoarseGrainedListBasedSet/plot_LISTSIZE_100/plot.txt" using 1:7:xtic(1) title "32" with linespoints lt 4 lc 12

#1000
set output '../plots/graphs/C_throughputXupRatio_graphs/linkedlist/CoarseGrainedListBasedSet/1000_CoarseGrainedListBasedSet.png'
set title "Performance Analysis-CoarseGrainedListBasedSet-LISTSIZE 1000 - C++"
plot "../plots/C_throughputXupRatio_plotdata/linkedlist/CoarseGrainedListBasedSet/plot_LISTSIZE_1000/plot.txt" using 1:2:xtic(1) title "1" with linespoints lt 7 lc 7, "../plots/C_throughputXupRatio_plotdata/linkedlist/CoarseGrainedListBasedSet/plot_LISTSIZE_1000/plot.txt" using 1:3:xtic(1) title "2" with linespoints lt 5 lc 28, "../plots/C_throughputXupRatio_plotdata/linkedlist/CoarseGrainedListBasedSet/plot_LISTSIZE_1000/plot.txt" using 1:4:xtic(1) title "4" with linespoints lt 9 lc 6, "../plots/C_throughputXupRatio_plotdata/linkedlist/CoarseGrainedListBasedSet/plot_LISTSIZE_1000/plot.txt" using 1:5:xtic(1) title "8" with linespoints lt 2 lc 3, "../plots/C_throughputXupRatio_plotdata/linkedlist/CoarseGrainedListBasedSet/plot_LISTSIZE_1000/plot.txt" using 1:6:xtic(1) title "16" with linespoints lt 9 lc 8, "../plots/C_throughputXupRatio_plotdata/linkedlist/CoarseGrainedListBasedSet/plot_LISTSIZE_1000/plot.txt" using 1:7:xtic(1) title "32" with linespoints lt 4 lc 12

#8000
set output '../plots/graphs/C_throughputXupRatio_graphs/linkedlist/CoarseGrainedListBasedSet/8000_CoarseGrainedListBasedSet.png'
set title "Performance Analysis-CoarseGrainedListBasedSet-LISTSIZE 8000 - C++"
plot "../plots/C_throughputXupRatio_plotdata/linkedlist/CoarseGrainedListBasedSet/plot_LISTSIZE_8000/plot.txt" using 1:2:xtic(1) title "1" with linespoints lt 7 lc 7, "../plots/C_throughputXupRatio_plotdata/linkedlist/CoarseGrainedListBasedSet/plot_LISTSIZE_8000/plot.txt" using 1:3:xtic(1) title "2" with linespoints lt 5 lc 28, "../plots/C_throughputXupRatio_plotdata/linkedlist/CoarseGrainedListBasedSet/plot_LISTSIZE_8000/plot.txt" using 1:4:xtic(1) title "4" with linespoints lt 9 lc 6, "../plots/C_throughputXupRatio_plotdata/linkedlist/CoarseGrainedListBasedSet/plot_LISTSIZE_8000/plot.txt" using 1:5:xtic(1) title "8" with linespoints lt 2 lc 3, "../plots/C_throughputXupRatio_plotdata/linkedlist/CoarseGrainedListBasedSet/plot_LISTSIZE_8000/plot.txt" using 1:6:xtic(1) title "16" with linespoints lt 9 lc 8, "../plots/C_throughputXupRatio_plotdata/linkedlist/CoarseGrainedListBasedSet/plot_LISTSIZE_8000/plot.txt" using 1:7:xtic(1) title "32" with linespoints lt 4 lc 12
